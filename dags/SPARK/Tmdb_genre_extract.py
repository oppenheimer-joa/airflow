...
dag = DAG('spark_Tmdb_genre_extract',
      default_args = default_args,
      max_active_runs= 1,
      tags=['스파크','TMDB extract','genre'],
      schedule_interval= '30 8 * * 5')
...
t1 = SSHOperator(
    task_id = 'sh_test',
    command = f"ssh sparkserver 'sh /home/spark/code/main/sh/tmdb_genre_pyspark.sh {exe_date}' ",
    ssh_hook = sshHook2,
    do_xcom_push=False,
    dag=dag)
