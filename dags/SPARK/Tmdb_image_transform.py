...
dag = DAG('spark_Tmdb_image_transform',
      default_args = default_args,
      max_active_runs= 1,
      tags=['스파크','TMDB transform','image'],
...
t1 = SSHOperator(
    task_id = 'sh_test',
    command = f"ssh sparkserver 'sh /home/spark/code/main/sh/tmdb_pyspark.sh /home/spark/code/main/src/Tmdb_transform_images.py {exe_date}' ",
    ssh_hook = sshHook2,
    do_xcom_push=False,
    dag=dag)
