...
dag = DAG('spark_Tmdb_similar_transform',
...
t1 = SSHOperator(
    task_id = 'sh_test',
    command = f"ssh sparkserver 'sh /home/spark/code/main/sh/tmdb_pyspark.sh /home/spark/code/main/src/Tmdb_transform_similar.py {exe_date}' ",
    ssh_hook = sshHook2,
    do_xcom_push=False,
    dag=dag)
