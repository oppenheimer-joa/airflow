...
dag = DAG('spark_Imdb_academy_transform',
      default_args = default_args,
      max_active_runs= 1,
      tags=['스파크','IMDB transform','academy'],
...
t1 = SSHOperator(
    task_id = 'sh_test',
    command = f"ssh sparkserver 'sh /home/spark/code/main/sh/imdb_transform_pyspark.sh {exe_date} academy' ",
    ssh_hook = sshHook2,
    do_xcom_push=False,
    dag=dag)
